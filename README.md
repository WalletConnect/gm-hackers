...
> :warning: **Warning**: Cloudflare is currently facing [issues](https://www.cloudflarestatus.com/) under which `cloudflared` is also affected. As a temporary measure, refer to the [Deploy](#deploy-the-example-dapp) section instead.
